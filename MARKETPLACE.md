...
To publish: in this repo's UI, go to **Releases → v0.2.1 → Edit release → Marketplace section → check "Publish this Action to the GitHub Marketplace"**, then fill the fields below.
...
|---|---|---|---|
| `pin-binary` | yes | - | `skil-lock` release tag (e.g. `v0.2.1`). No floating refs. |
